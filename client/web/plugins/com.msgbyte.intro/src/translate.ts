...
export const Translate = {
  ...
  step1: localTrans({
    'zh-CN': '欢迎使用序语空间, 一个插件化的开源IM应用！',
    'en-US': 'Welcome to 序语空间, a pluginify open source IM application!',
  }),
  step2: localTrans({
    'zh-CN': '这是导航栏, 在这里可以切换序语空间的各个主要页面。',
    'en-US':
      'This is the navigation bar, where you can switch between the main pages of 序语空间.',
  }),
  step3: localTrans({
  ...
  step7: localTrans({
    'zh-CN': '这是内容区，用于显示主要内容，也是序语空间展示内容的地方。',
    'en-US':
      'This is the content area, which is used to display the main content, and it is also where 序语空间 displays the content.',
  }),
  step8: localTrans({
    'zh-CN':
