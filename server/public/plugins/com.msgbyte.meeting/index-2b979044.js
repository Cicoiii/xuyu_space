definePlugin('@plugins/com.msgbyte.meeting/index-2b979044.js', ['require', 'exports', '@capital/common', '@capital/component', 'react'], (function (require, exports, common, component, React) { 'use strict';
  ...
  async function startFastMeeting(meetingId) {
    const module = await new Promise(function (resolve, reject) { require(['./index-201aec76'], resolve, reject); });
  ...
  common.regPluginRootRoute({
    ...
    component: common.Loadable(() => new Promise(function (resolve, reject) { require(['./MeetingUrlWrapper-2da157bd'], resolve, reject); }))
  });
...
//# sourceMappingURL=index-2b979044.js.map
