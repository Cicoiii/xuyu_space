definePlugin('@plugins/com.msgbyte.agora/index-a11c88dc.js', ['require', 'exports', '@capital/common', '@capital/component', 'react'], (function (require, exports, common, component, React) { 'use strict';
  ...
  const FloatMeetingWindow = component.Loadable(() => new Promise(function (resolve, reject) { require(['./window-6716f199'], resolve, reject); }).then((module) => module.FloatMeetingWindow), {
    showLoading: true
  });
...
//# sourceMappingURL=index-a11c88dc.js.map
